...
public class SummonManager : MonoBehaviour
{
    ...
    private Queue<GameObject> creepQueue = new Queue<GameObject>();
    private Queue<GameObject> demonQueue = new Queue<GameObject>();
    ...
    public void ReturnObjectToPool(Queue<GameObject> pool, GameObject obj)
    {
